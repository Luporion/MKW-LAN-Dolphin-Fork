...
- Add explanation about variable module_path in [module.c] /src/brainslug-wii-vanilla/src/modules/module.c. This way, you can change were Brainslug looks voor modules and easily make different folders for different mods.
