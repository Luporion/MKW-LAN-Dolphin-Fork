...
BSLUG_MODULE_GAME("????");
BSLUG_MODULE_NAME("GCT Loader 4 Wiimm Bot");
BSLUG_MODULE_VERSION("v1.0");
BSLUG_MODULE_AUTHOR("JoshuaMKW, InvoxiPlayGames, Yuri, Calvin");
...
static const unsigned char codehandler[] = {
  ...
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x34, 0x56, 0x78, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00
};
...
static int OSLink_patches(void* location1, void* location2)
{
  SD_Mount();
  char codepath[34];
  sprintf(codepath, "sd:/codes/wiimm-bot/%.6s.gct", (char*)0x80000000);
  static FILE_STRUCT fs;
  int fd = SD_open(&fs, codepath, O_RDONLY);
  SD_read(fd, (void*)0x800028B8, fs.filesize);
  SD_close(fd);

  return OSLink(location1, location2);
}
